...
Now you don’t need to run lint scripts to fix errors manually. The extensions will automatically fix all the auto-fixable errors on save.ExternalLinkCardExternalLinkCardYTCard: ExternalLinkCardExternalLinkCard~/components/blog/ExternalLinkCard
